...
//The below two structs are used to store the locations the ai will go while searching for the health pack
// and where they will hide from the player when its not avaible
struct SearchData
{
...
struct LevelData
{
	...
	std::vector<SearchData> m_search;
	std::vector<SafestData> m_safest;
};
